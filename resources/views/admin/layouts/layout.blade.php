...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" data-enable-remember="true" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"></i></a>
            </li>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ url('/')  }}" class="brand-link">
            <img src="{{ asset('assets/admin/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: 0.8;" />
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block"> @if (Auth::check()) {{ Auth::user()->name }} ({{ Auth::user()->email }}) @else Гость @endif</a>
                </div>
            </div>
            <!-- Sidebar Menu -->
            <nav class="mt-2">
...
<script>
    $(".nav-sidebar a").each(function () {
        ...
        if (link == location) {
            ...
            $(this).closest(".had-treeview").addClass("menu-open");
        }
    });
    $(".select2").select2();
</script>
                         ...
                         <tr>
                            ...
                            <td>
                                <button
                                    ...
                                    onclick="setFieldsForModalUpdate('${data[index].id}','${data[index].title}','${data[index].category_id}','${data[index].content}','${data[index].description}',)"
                                    data-toggle="modal"
                         ...
                         <tr>
                            ...
                            <td>
                                <button
                                    type="button"
                                    class="btn btn-default"
                                    onclick="setFieldsForModalUpdate('${data.article.id}','${data.article.title}','${data.article.category_id}','${data.article.content}','${data.article.description}',)"
                                    data-toggle="modal"
                                    data-target="#modal-edit"
                                >
                                    <i class="fas fa-pencil-alt"></i>
