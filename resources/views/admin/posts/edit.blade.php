...
@method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('content') is-invalid @enderror" rows="3"  id="content" rows="5" name="content">{{$post->content}}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <img src="  {{$post->getImage() }}" width="200"  alt="" class="img-thumbnail">
